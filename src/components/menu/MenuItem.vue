<template>
  <div class="menu-item">
    <div class="menu-item-details">
      <img :src="imageSrc" alt="Menu Item" class="menu-item-img" @error="onImageError" />
    ...
    <div class="menu-item-actions">
      <button @click="onEdit(menuItem.id)"><span class="icon">✏️</span> Edit</button>
      <button @click="onDelete(menuItem.id)"><span class="icon">🗑️</span> Delete</button>
    </div>
  </div>
</template>
